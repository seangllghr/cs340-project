...
*** TODO Indices
**** TODO Ticker Symbol [ascending] :simple:
**** TODO Industry [ascending] Analyst Recom [descending] :compound:
*** TODO Screenshots [1/19]
:properties:
:cookie_data: recursive
:end:
- [-] Collection Management:
  ...
  - [ ] Document creation of necessary single or compound indices
    - [ ] simple index on `Ticker` [ascending]
    - [ ] compound index on `Industry` [ascending] `Analyst Recom` [descending]
- [ ] Document Manipulation:
...
***** TODO Database Creation and Import
***** TODO Index Design and Implementation
...
***** TODO Command line tools
****** TODO sma-spread
****** TODO tickers-by-industry
****** TODO agg-shares
**** TODO Stock Record System API
***** TODO stock-client.sh :aside:
***** TODO Basic CRUD Operations
****** TODO Create
****** TODO Read
****** TODO Update
****** TODO Delete
***** TODO Advanced Reports
****** TODO Portfolio Report
****** TODO Industry Report
