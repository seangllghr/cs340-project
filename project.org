...
***** TODO Update numeric 'Value' matching input string 'Ticker'
****** TODO Read user input from stdin
****** TODO Read uers input from prompt
***** TODO Delete stock record matching input string 'Ticker'
****** TODO Read user input from stdin
****** TODO Read uers input from prompt
***** TODO Find documents with '50-Day SMA' in user-defined range
****** TODO Read user input from stdin
